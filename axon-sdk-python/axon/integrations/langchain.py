...
# Attempt to load LangChain components dynamically to keep installation light
try:
    ...
    try:
        ...
        # Stub fallbacks if LangChain is not installed
        class BaseTool:
...
class AxonLockTool(BaseTool):
    ...
    async def _arun(self, command: str) -> str:
        ...
        try:
            ...
            # Check if lock manager uses async methods
...
class AxonReceiptCallbackHandler(BaseCallbackHandler):
    ...
    """
    def __init__(self, client: Any, input_text: str = "LangChain Run"):
        super().__init__()
        self.client = client
    ...
    def on_chain_end(self, outputs: Dict[str, Any], **kwargs: Any) -> Any:
        ...
        # Build reasoning receipt payload
        ...
        try:
            ...
            if is_async_create:
                # Spawn receipt generation as background task in current loop if available
                try:
                    ...
                    # Fallback for threads without event loops
